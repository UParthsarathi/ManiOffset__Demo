...
const CONTENT: ProductContentDataV2 = {
  ...
  tableRows: [
    { category: "Standard Forms", rowSpan: 2, size: "1/4 Demy", dimensions: "8.5\" x 11\"", description: "Widely used banking format" },
    { size: "A4", dimensions: "8.3\" x 11.7\"" },
    { category: "Compact Forms", size: "1/4 Crown", dimensions: "7\" x 9.5\"", description: "Balanced forms for quick entries" },
    { category: "Extended Forms", size: "Legal", dimensions: "8.5\" x 14\"", description: "Used for detailed documentation" },
    { category: "Custom", size: "Variable", dimensions: "Flexible", description: "As per bank format and layout" }
  ],
