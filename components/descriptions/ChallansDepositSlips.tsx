...
const CONTENT: ProductContentDataV2 = {
  ...
  tableTitle: "Challan and deposit slip sizes",
  tableRows: [
    { category: "Custom", size: "Variable", dimensions: "Flexible", description: "Made to match your format" }
  ],
  orderingTitle: "Ordering and pricing",
  orderingParagraphs: [
    "Pricing follows <strong>format, parts per set, and quantity</strong>. Challans and slips are made to match your bank's existing format, so send a sample and we replicate it exactly. For bank challan printing and slip supply we quote recurring runs, with orders from 200 sets."
  ],
